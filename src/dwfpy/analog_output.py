...
class AnalogOutput:
    ...
    class Channel:
        ...
        class Trigger:
            ...
            def source(self) -> TriggerSource:
                ...
                return TriggerSource(api.dwf_analog_out_trigger_source_get(
                    self._device.handle, self._channel))
            ...
            def slope(self) -> TriggerSlope:
                ...
                return TriggerSlope(api.dwf_analog_out_trigger_slope_get(
                    self._device.handle, self._channel))
        ...
        class Node:
            ...
            def function_info(self) -> Tuple[Function, ...]:
                ...
                return Helpers.map_enum_values(
                    Function, api.dwf_analog_out_node_function_info(self._device.handle, self._channel, self._node))

            @property
            def function(self) -> Function:
                """Gets or sets the generator function."""
                return Function(api.dwf_analog_out_node_function_get(
        ...
        def __init__(self, module, channel):
            ...
            self._nodes = tuple(
                self.Node(self, v) for v in AnalogOutputNode if (nodes & (1 << v.value)) != 0)
    ...
    def __init__(self, device):
        self._device = device
        self._channels = tuple(self.Channel(self, i) for i in range(api.dwf_analog_out_count(self._device.handle)))
