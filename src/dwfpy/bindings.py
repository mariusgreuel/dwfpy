...
dwf_digital_spi_write_read32 = _dwf_function('FDwfDigitalSpiWriteRead32', (_IN, HDWF, 'hdwf'), (_IN, c_int, 'cDQ'), (_IN, c_int, 'cBitPerWord'), (_IN, POINTER(c_uint), 'rgTX'), (_IN, c_int, 'cTX'), (_IN, POINTER(c_uint), 'rgRX'), (_IN, c_int, 'cRX'))
...
dwf_digital_spi_read32 = _dwf_function('FDwfDigitalSpiRead32', (_IN, HDWF, 'hdwf'), (_IN, c_int, 'cDQ'), (_IN, c_int, 'cBitPerWord'), (_IN, POINTER(c_uint), 'rgRX'), (_IN, c_int, 'cRX'))
...
if _version >= (3, 21, 0):
    dwf_digital_spi_cmd_write_read = _dwf_function('FDwfDigitalSpiCmdWriteRead', (_IN, HDWF, 'hdwf'), (_IN, c_int, 'cBitCmd'), (_IN, c_uint, 'cmd'), (_IN, c_int, 'cDummy'), (_IN, c_int, 'cDQ'), (_IN, c_int, 'cBitPerWord'), (_IN, POINTER(c_ubyte), 'rgTX'), (_IN, c_int, 'cTX'), (_IN, POINTER(c_ubyte), 'rgRX'), (_IN, c_int, 'cRX'))
    dwf_digital_spi_cmd_write_read16 = _dwf_function('FDwfDigitalSpiCmdWriteRead16', (_IN, HDWF, 'hdwf'), (_IN, c_int, 'cBitCmd'), (_IN, c_uint, 'cmd'), (_IN, c_int, 'cDummy'), (_IN, c_int, 'cDQ'), (_IN, c_int, 'cBitPerWord'), (_IN, POINTER(c_ushort), 'rgTX'), (_IN, c_int, 'cTX'), (_IN, POINTER(c_ushort), 'rgRX'), (_IN, c_int, 'cRX'))
    dwf_digital_spi_cmd_write_read32 = _dwf_function('FDwfDigitalSpiCmdWriteRead32', (_IN, HDWF, 'hdwf'), (_IN, c_int, 'cBitCmd'), (_IN, c_uint, 'cmd'), (_IN, c_int, 'cDummy'), (_IN, c_int, 'cDQ'), (_IN, c_int, 'cBitPerWord'), (_IN, POINTER(c_uint), 'rgTX'), (_IN, c_int, 'cTX'), (_IN, POINTER(c_uint), 'rgRX'), (_IN, c_int, 'cRX'))
    dwf_digital_spi_cmd_read = _dwf_function('FDwfDigitalSpiCmdRead', (_IN, HDWF, 'hdwf'), (_IN, c_int, 'cBitCmd'), (_IN, c_uint, 'cmd'), (_IN, c_int, 'cDummy'), (_IN, c_int, 'cDQ'), (_IN, c_int, 'cBitPerWord'), (_IN, POINTER(c_ubyte), 'rgRX'), (_IN, c_int, 'cRX'))
    ...
    dwf_digital_spi_cmd_read16 = _dwf_function('FDwfDigitalSpiCmdRead16', (_IN, HDWF, 'hdwf'), (_IN, c_int, 'cBitCmd'), (_IN, c_uint, 'cmd'), (_IN, c_int, 'cDummy'), (_IN, c_int, 'cDQ'), (_IN, c_int, 'cBitPerWord'), (_IN, POINTER(c_ushort), 'rgRX'), (_IN, c_int, 'cRX'))
    dwf_digital_spi_cmd_read32 = _dwf_function('FDwfDigitalSpiCmdRead32', (_IN, HDWF, 'hdwf'), (_IN, c_int, 'cBitCmd'), (_IN, c_uint, 'cmd'), (_IN, c_int, 'cDummy'), (_IN, c_int, 'cDQ'), (_IN, c_int, 'cBitPerWord'), (_IN, POINTER(c_uint), 'rgRX'), (_IN, c_int, 'cRX'))
